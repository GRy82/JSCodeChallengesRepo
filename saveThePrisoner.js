...
function saveThePrisoner(prisonerQty, treatQty, startingChair) {
    let lastRevolution = treatQty % prisonerQty - 1;
    if(startingChair + lastRevolution > prisonerQty)
        return lastRevolution - (prisonerQty - startingChair);
    return startingChair + lastRevolution;
}
